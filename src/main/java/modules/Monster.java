...
public class Monster {
    ...
    public Timestamp getLastSleep() { return lastSleep; }
    ...
    public void sleep() {
        if(sleepLevel >= MAX_SLEEP_LEVEL){
            throw new UnsupportedOperationException("You cannot make monster sleep anymore!");
        }
        try(Connection con = DB.sql2o.open()){
